...
<title>真好智能社区</title>
<script src="<%=request.getContextPath()%>/framework/BJUI/js/jquery-1.7.2.min.js"></script>
<script src="<%=request.getContextPath()%>/framework/BJUI/js/jquery.cookie.js"></script>
<script src="<%=request.getContextPath()%>/resource/scripts/sha256.js"></script>
<link href="<%=request.getContextPath()%>/framework/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(${pageContext.request.contextPath}/resource/images/home/loginbg_01.jpg) no-repeat center center fixed;
...
<script src="<%=request.getContextPath()%>/framework/BJUI/plugins/bootstrap.min.js"></script>
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(${pageContext.request.contextPath}/resource/images/home/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
...
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="${pageContext.request.contextPath}/resource/images/home/logo.png" >
        </div>
        <!--
	...
	<div class="bottom">Copyright &copy; 2015 <a href="http://www.zhenhaoapp.com/" target="_blank">北京正开互动科技有限公司 </a></div>
</div>
</body>
</html>